...
當夥伴擔心「漲價了是不是變難賣」、「BP降了收入會不會變少」，用以下四個角度引導思考，幫助他們從焦慮轉向看見機會。這是協助思考的框架，實際數字以官方制度為準。

### 1. 系統幫你顧客人：自動留客引擎
貴賓/尊榮會員制度的本質，是讓客戶為了「把進度條湊滿」、「把回饋金用掉」，主動登入系統自己購買。這代表：
- 你的售後服務時間大幅減少
- 省下來的精力可以拿去開發新客戶
- 客戶忠誠度由制度本身維繫，不靠你一直拜託回購
這是「系統 vs. 個人努力」的典型範例：把留客這件事從你的時間成本，轉換成制度的自動運行。

### 2. SP 全面大漲：晉升比以前更快
雖然部分單品 BP 微降，但所有調漲售價的產品 SP 全部提高。例如：
- 活妍專科保養組 SP +8（81→89）
- 隨型手搖蛋白飲 SP +10（89→99），雖然 BP 降幅最大，但 SP 是最大贏家
這代表：賣出一樣的數量，晉升速度比以前快。而位階晉升後，整體獎金 % 數放大，長遠的「晉升複利」遠超過單品微降的幾點 BP。

### 3. 入會套組：最大包的獎金一毛沒動
入會套組（僅限入會後30天內購買）售價、SP、BP 均維持不變：
- ICD全系列套組 / 內外亮采全系列套組：55,800元，SP 1,500，BP 1,150
- 內外亮采基礎組：37,200元，SP 1,000，BP 760
這是公司留給夥伴的「主力金礦」：把老客戶交給系統維護，主力放在招募新人、推廣套組，利潤最豐厚且不受折扣稀釋影響。

### 4. 新品機會 + 未稅計算的隱性保護
- 回饋金（RP）以**未稅金額的5%**計算，折扣吃掉的 BP 比例相對較少，公司在極端折扣下仍幫經銷商守住利潤底線
- 新品（平衡潔顏凝膠 960元、光點100精華水/精華/乳霜）為高忠誠老客戶提供嘗鮮理由，帶動整體 SP/BP 成長

### 給夥伴的行動方向（引導思考用）
1. 用 VIP/VVIP 制度「寵壞」老客戶，讓他們自動回購、衝高 SP 加速晉升
2. 主力招募新人，推廣 BP 滿血的入會套組，賺取最大包的獎金
3. 用光點100高階保養系列喚醒已享有折扣的忠誠 VIP，帶動額外業績
